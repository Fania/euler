...
test39x p = [ (x,y,z) | x <- [1..p], y <- [1..(p-x)], z <- [1..(p-x-y)], 
                  (isPyth x y z) && (x+y+z == p),
                  x < y && y < z ]

test39y n = [ (p,xs) | p <- [1..n], let xs = test39x p, xs /= [] ]
...
test39z = maximum $ map length $ map snd [(12,[(3,4,5)]),(24,[(6,8,10)]),(30,[(5,12,13)]),(36,[(9,12,15)]),(40,[(8,15,17)]),(48,[(12,16,20)]),(56,[(7,24,25)]),(60,[(10,24,26),(15,20,25)]),(70,[(20,21,29)]),(72,[(18,24,30)]),(80,[(16,30,34)]),(84,[(12,35,37),(21,28,35)]),(90,[(9,40,41),(15,36,39)]),(96,[(24,32,40)]),(108,[(27,36,45)]),(112,[(14,48,50)]),(120,[(20,48,52),(24,45,51),(30,40,50)]),(126,[(28,45,53)]),(132,[(11,60,61),(33,44,55)]),(140,[(40,42,58)]),(144,[(16,63,65),(36,48,60)]),(150,[(25,60,65)]),(154,[(33,56,65)]),(156,[(39,52,65)]),(160,[(32,60,68)]),(168,[(21,72,75),(24,70,74),(42,56,70)]),(176,[(48,55,73)]),(180,[(18,80,82),(30,72,78),(45,60,75)]),(182,[(13,84,85)]),(192,[(48,64,80)]),(198,[(36,77,85)]),(200,[(40,75,85)])]
...
-- 41: Pandigital prime
nineDigitPrimes = [ x | x <- primes, (length (intToList x) == 9) ]

nDigitPrimes n = [ list2Int xs | xs <- (permutations [1..n]), isPrime $ list2Int xs ]

problem41 = maximum [ maximum ns | x <- [2..9], let ns = nDigitPrimes x, ns /= [] ]
-- 7652413
